...
public class GradeParser {
    ...
    public JSONObject getlinkedMajor() throws JSONException {
        try {
            InputStream is = new URL("https://raw.githubusercontent.com/incuriositas/capstoneDatabase/master/gradePoint/linkedMajor.json").openStream();
            BufferedReader rd = new BufferedReader(new InputStreamReader(is, "UTF-8"));
            String str;
            StringBuffer buffer = new StringBuffer();
            while((str = rd.readLine()) != null){
